...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLL_25_175 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 10 -mdiv 1 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 73 -trims 0 -phases 0 -trims_r -bdiv 29 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_25_175 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "25.172414";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  28, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  72, 
        ...
        CLKOS_DIV=>  29, CLKOP_DIV=>  73, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_25_175 is
    for Structure
