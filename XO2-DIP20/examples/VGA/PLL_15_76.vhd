...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLL_15_76 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 10 -mdiv 1 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 52 -trims 0 -phases 0 -trims_r -bdiv 33 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_15_76 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "15.757576";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  32, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  51, 
        ...
        CLKOS_DIV=>  33, CLKOP_DIV=>  52, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_15_76 is
    for Structure
