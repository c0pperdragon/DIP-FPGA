...
architecture Structure of PLL_8x120 is
    ...
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "120.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        PLL_USE_WB=> "DISABLED", CLKOS3_FPHASE=>  4, CLKOS3_CPHASE=>  4, 
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  4, CLKOS_FPHASE=>  4, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  4, CLKOS2_DIV=>  4, 
        CLKOS_DIV=>  4, CLKOP_DIV=>  4, CLKFB_DIV=>  12, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_8x120 is
    for Structure
