...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLL -lang vhdl -synth lse -arch xo2c00 -type pll -fin 10 -fclkop 120 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  3, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  4, CLKFB_DIV=>  12, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
