...
-- Module  Version: 5.7
--C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n PLL200 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 10 -fclkop 200 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  3, CLKFB_DIV=>  20, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
