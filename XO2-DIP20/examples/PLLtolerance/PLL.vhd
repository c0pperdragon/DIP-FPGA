...
-- Module  Version: 5.7
--C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n PLL -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 23.9 -mdiv 1 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 15 -trims 0 -phases 0 -trims_r -bdiv 5 -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "71.700000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "23.900000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "23.900000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  4, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  14, 
        ...
        CLKOS_DIV=>  5, CLKOP_DIV=>  15, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
